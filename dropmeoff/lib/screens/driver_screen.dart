...
import 'package:dropmeoff/pages/travel_screen.dart';
                        ...
                        onPressed: () {
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                title: Text('ยืนยันการให้บริการ'),
                                content: Text('ยืนยันจะรับเพื่อนคนนี้ใช่ไหม'),
                                actions: <Widget>[
                                  TextButton(
                                    onPressed: () {
                                  ...
                                  TextButton(
                                    ...
                                    onPressed: () async{
                                      ...
                                      final requestReference = FirebaseFirestore.instance.collection('requests').doc(requestId);
                                      /////////////////////////////////////
                                      ...
                                      try {
                                        ...
                                        await requestReference.update({'driverId': uid});
                                        await requestReference.update({'driverphone': _phone});
                                        await requestReference.update({'drivername': drivername});
